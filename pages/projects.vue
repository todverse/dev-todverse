...
<template>
    <div class="mx-auto min-h-screen max-w-screen-xl px-6 py-12 font-mono md:px-12 md:py-20 lg:px-24 lg:py-0">
        <div class="lg:py-24">
            ...
            <h1 class="text-4xl font-bold tracking-tight text-terminal-green sm:text-5xl glitch mt-4 ml-4" data-text="All Projects">All Projects</h1>
            ...
            <div class="mt-12 overflow-x-auto">
                <table id="content" class="w-full border-collapse text-left">
                    <thead class="sticky top-0 z-10 border-b border-terminal-green/20 bg-terminal-bg/80 px-6 py-5 backdrop-blur">
                        <tr>
                            <th class="py-4 pr-8 text-[10px] font-bold uppercase tracking-widest text-slate-400">Year</th>
                            <th class="py-4 pr-8 text-[10px] font-bold uppercase tracking-widest text-slate-400">Project</th>
                            <th class="hidden py-4 pr-8 text-[10px] font-bold uppercase tracking-widest text-slate-400 lg:table-cell">Built_with</th>
                            <th class="hidden py-4 pr-8 text-[10px] font-bold uppercase tracking-widest text-slate-400 lg:table-cell">Description</th>
                        </tr>
                    </thead>
                    <tbody class="text-slate-200">
                        <tr v-for="project in aboutme.projects" :key="project.name" class="border-b border-terminal-green/10 last:border-none group hover:bg-terminal-green/[0.02] transition-colors">
